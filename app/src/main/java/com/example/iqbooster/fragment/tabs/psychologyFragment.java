 ...
 * Use the {@link psychologyFragment#newInstance} factory method to
...
public class psychologyFragment extends Fragment {
    ...
    private final String TAG = "psychologyFragment";
...
//                        if (currPostTags != null && currPostTags.isPsychology()) {
...
//        });
        ...
        postRef.orderByChild(getContext().getResources().getString(R.string.db_timestamp)).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (currPost.getTags().isPsychology()) {
